...
def test_openapi_declares_the_runtime_error_envelope_for_every_operation() -> None:
    ...
    expected_errors = {
        ...
        ("/api/v1/memory/settings", "get"): {422},
        ("/api/v1/memory/settings", "patch"): {400, 409, 422},
        ("/api/v1/memory/provider-consent", "post"): {400, 409, 422},
        ("/api/v1/memories", "get"): {400, 422},
        ("/api/v1/memories", "post"): {400, 409, 422},
        ("/api/v1/memories/{memory_id}", "get"): {404, 422},
        ("/api/v1/memories/{memory_id}/approve", "post"): {404, 409, 422},
        ("/api/v1/memories/{memory_id}/correct", "post"): {
            400,
            404,
            409,
            422,
        },
        ("/api/v1/memories/{memory_id}/forget", "post"): {404, 409, 422},
        ("/api/v1/memories/{memory_id}/purge", "post"): {404, 409, 422},
        ...
        ("/api/v1/runs/{run_id}/memory-context", "get"): {404, 422},
