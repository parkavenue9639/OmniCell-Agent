...
from omnicell_agent.pipeline.graph import build_exploratory_analysis_engine
...
def test_exploratory_analysis_execution():
    """
    ...
    app = build_exploratory_analysis_engine()
    ...
    with analysis_python_session_scope(host_workspace=project_root / "data"):
...
if __name__ == "__main__":
    test_exploratory_analysis_execution()
